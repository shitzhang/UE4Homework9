...
{
public:
	FCunstomOnlineSubsystemBPCallHelper(const TCHAR* CallFunctionContext, UObject* WorldContextObject,
 ...
 */
UCLASS()
class PROTOTYPE_API UCustomCreateSessionCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	GENERATED_BODY()

	UCustomCreateSessionCallbackProxy(const FObjectInitializer& ObjectInitializer);
	...
	static UCustomCreateSessionCallbackProxy* CreateCustomSession(UObject* WorldContextObject,
	                                                              class APlayerController* PlayerController,
	                                                              int32 PublicConnections, bool bUseLAN);
