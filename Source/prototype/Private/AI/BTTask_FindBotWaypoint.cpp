...
{
	AShooterZombieAIController* MyController = Cast<AShooterZombieAIController>(OwnerComp.GetAIOwner());
	...
	UGameplayStatics::GetAllActorsOfClass(MyController, AShooterBotWaypoint::StaticClass(), AllWaypoints);
